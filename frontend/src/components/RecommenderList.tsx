/**
 * 🏗️  DEVELOPMENT GUIDE - Recommender List Component
 * 
...
import { RecommenderQuestion } from '../types/RecommenderTypes';

interface RecommenderListProps {
  data: RecommenderQuestion[];
  onEdit: (question: RecommenderQuestion) => void;
  onDelete: (id: string) => void;
}

const RecommenderList: React.FC<RecommenderListProps> = ({ data, onEdit, onDelete }) => {
  return (
